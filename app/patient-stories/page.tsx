  ...
  return (
    <>
      <section className="bg-canvas">
        <div className="container-wide pt-32 pb-16 md:pt-40 md:pb-24">
          <p className="eyebrow mb-4">Patient Stories</p>
          <h1 className="font-display text-3xl md:text-5xl font-semibold text-heading max-w-2xl">
            Real experiences from patients in our regenerative medicine program.
          </h1>

          <div className="mt-12 rounded-2xl bg-card border border-line p-8 md:p-10 max-w-2xl">
